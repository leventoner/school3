...
@Component({
    ...
    <div class="max-w-3xl mx-auto">
      <h2 class="text-3xl font-extrabold text-gray-900 mb-8 flex items-center">
        <span class="w-10 h-10 bg-indigo-600 text-white rounded-lg flex items-center justify-center mr-4 text-xl">+</span>
        Add New Student
      </h2>
      
      <form [formGroup]="studentForm" (ngSubmit)="onSubmit()" class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        <div class="border-t border-gray-100 pt-8 mt-8">
          <div class="flex justify-between items-center mb-6">
            <h3 class="text-xl font-bold text-gray-900 underline decoration-indigo-200">Course Grades</h3>
            <button type="button" (click)="addCourse()" class="text-sm bg-indigo-50 text-indigo-600 px-4 py-2 rounded-lg font-bold hover:bg-indigo-100 transition">
              + Add Course
            </button>
          </div>
          ...
          <div formArrayName="courses" class="space-y-4">
            <div *ngFor="let c of coursesFormArray.controls; let i=index" [formGroupName]="i" class="flex items-center space-x-4 bg-gray-50 p-4 rounded-xl border border-gray-100 animate-fadeIn">
              <div class="flex-grow">
                ...
                <select formControlName="course" class="w-full bg-white border-none rounded-lg text-gray-700 focus:ring-2 focus:ring-indigo-500">
              ...
              <div class="w-24">
                ...
                <select formControlName="grade" class="w-full bg-white border-none rounded-lg text-gray-700 focus:ring-2 focus:ring-indigo-500">
        ...
        <div class="mt-12 flex space-x-4">
          <button type="submit" [disabled]="studentForm.invalid" 
            class="flex-grow py-4 bg-indigo-600 text-white rounded-xl font-bold text-lg hover:bg-indigo-700 shadow-lg shadow-indigo-100 transition disabled:bg-gray-300">
            Save Student
          </button>
...
export class AddStudentComponent {
    ...
    constructor(
        ...
        this.studentForm = this.fb.group({
            ...
            studentClass: ['1A', Validators.required],
